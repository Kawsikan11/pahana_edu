...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="#">About</a>
            <a href="#">Contact</a>
            <button class="cart-btn" onclick="checkLogin()">🛒 View Cart</button>
            <button class="login-btn" onclick="location.href='login.jsp'">Login</button>
        </div>
    </nav>
...
<script>
  // Example: You can replace this with a real login check from session/backend
  let isLoggedIn = false; // assume user is not logged in

  function checkLogin() {
    if (!isLoggedIn) {
      alert("⚠️ Please register or login to add items to the cart.");
      // Optional: redirect user to login/register page
      window.location.href = "login.jsp"; 
    } else {
      alert("✅ Item added to cart!");
      // Here you would call your real 'Add to Cart' function
    }
  }
</script>
            </form>
